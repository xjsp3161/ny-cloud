...
public class SysPermissionController {
    ...
    @ResourcesMapping(element = "查询", code = "sys_permission_resource_tree")
    @PreAuth("hasAuthority('sys_permission_resource_tree')")
    @GetMapping("/permissionResourceTree")
    public HttpResponse permissionResourceTree(PermissionResourceDto dto) {
        return new HttpResponse().success(sysPermissionService.selectPermissionResourceTree(dto.getPermissionId()));
    }
