...
public class SysUserGroupRoleController {
    ...
    @ResourcesMapping(elements = "添加", code = "sys_group_role_add")
    ...
    @ResourcesMapping(elements = "添加", code = "sys_group_role_delete")
    ...
    @ResourcesMapping(elements = "查询", code = "sys_group_no_role")
    ...
    @ResourcesMapping(elements = "查询", code = "sys_group_role")
