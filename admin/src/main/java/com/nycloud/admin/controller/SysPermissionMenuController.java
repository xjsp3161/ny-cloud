...
public class SysPermissionMenuController {
    ...
    @ResourcesMapping(elements = "添加", code = "sys_permission_menu_add")
    ...
    @ResourcesMapping(elements = "删除", code = "sys_permission_menu_delete")
    ...
    @ResourcesMapping(elements = "查询", code = "sys_permission_no_menu_tree_get")
    ...
    @ResourcesMapping(elements = "查询", code = "sys_permission_menu_tree_get")
