...
public class SysPermissionResourceServicePk extends BaseService<SysPermissionResourcePkMapper, SysPermissionResourcePk> {
    ...
    public ResponsePage loadPermissionNoRelationResources(PermissionResourceDto dto){
        PageHelper.startPage(dto.getPage(), dto.getSize());
        Map<String, Object> map = getQueryParams(dto);
        return new ResponsePage<>(sysResourceMapper.selectPermissionNoResources(map));
    }

    public ResponsePage loadPermissionResources(PermissionResourceDto dto){
        PageHelper.startPage(dto.getPage(), dto.getSize());
        Map<String, Object> map = getQueryParams(dto);
        return new ResponsePage<>(sysResourceMapper.selectPermissionResources(map));
    }
