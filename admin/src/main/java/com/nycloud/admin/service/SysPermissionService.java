...
public class SysPermissionService extends BaseService<SysPermissionMapper, SysPermission> {
    ...
    public List<SysResource> selectPermissionResourceTree(int permissionId) {
        List<SysResource> allSysResources = this.sysResourceMapper.selectAllResources();
        List<SysResource> currentSysResources = this.sysResourceMapper.selectPermissionResources(new HashMap<String, Object>(1) {{
