...
DEPLOY_PATH=/Users/super/Desktop/Github/maven-repo
CURRENT_PATH=`pwd`
...
deployFunc(){
  ...
  cd $CURRENT_PATH
  # 开始deploy
  mvn clean deploy -Dmaven.test.skip  -DaltDeploymentRepository=self-mvn-repo::default::file:/Users/super/Desktop/Github/maven-repo/repository
